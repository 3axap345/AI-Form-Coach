...
The source code is available under the [MIT License](LICENSE). Dataset and model
artifacts remain external inputs and may have separate licence or access terms.
